...
class Quadcopter():
    ...
    def get_motor_speeds(self,quad_name):
        return (self.quads[quad_name]['m1'].thrust,self.quads[quad_name]['m2'].thrust,self.quads[quad_name]['m3'].thrust, self.quads[quad_name]['m4'].thrust)
